...
struct regBC3
{
    ...
    void decod_str_bc3(const std::string &str);
    virtual void Escribe(std::ostream &os)const= 0;
    virtual ~regBC3(void) {}
    static std::string limpia_str(const std::string &);
};

std::ostream &operator<<(std::ostream &os,const regBC3 &r);

template<class T>
struct regBC3_lista_reg: public std::deque<T>, public regBC3
{
    typedef typename std::deque<T>::const_iterator const_iterator;

    regBC3_lista_reg(void) {}
    regBC3_lista_reg(const std::string &str);
    virtual StrTok &decod_bc3(StrTok &strtk);
    virtual void Escribe(std::ostream &os) const;
};

template<class T>
regBC3_lista_reg<T>::regBC3_lista_reg(const std::string &str)
{
...
{
    if(!strtk.size()) return strtk; //Nada a decodificar.
    T lt;
    do
    {
        lt.decod_bc3(strtk);
...
template<class T>
void regBC3_lista_reg<T>::Escribe(std::ostream &os) const
{
...
//Elemento de una descomposición
{
    ...
    regBC3_desc(const std::string &str);
    virtual StrTok &decod_bc3(StrTok &strtk);
    inline bool EsCapituloUObra(void) const
    {
        return (codigo.find("#")<codigo.length());
    }
    inline bool EsCapitulo(void) const
    {
        return es_codigo_capitulo(codigo);
    }
    inline bool EsObra(void) const
    {
...
//Corresponde a un registro ~D de BC3.
{
    regBC3_d(void)
        : regBC3_lista_desc() {}
    regBC3_d(const std::string &str);
    virtual StrTok &decod_bc3(StrTok &strtk);
    bool EsCapitulo(const regBC3_desc &r,const std::set<std::string> &nombres_capitulo) const;
    regBC3_d FiltraCapitulos(const std::set<std::string> &nombres_capitulo) const;
    regBC3_d FiltraPrecios(const std::set<std::string> &nombres_capitulo) const;
};
...
struct regBC3_linea_med: public regBC3
{
    ...
    regBC3_linea_med(void)
        : tipo(0),med() {}
    regBC3_linea_med(const std::string &str);
    virtual StrTok &decod_bc3(StrTok &strtk);
    virtual void Escribe(std::ostream &os) const;
};
...
struct regBC3_ruta: public StrTok::dq_campos, public regBC3
{
    virtual StrTok &decod_bc3(StrTok &strtk);
    size_t Capitulos(void) const
    {
        return size()-1;
    }
    std::string Posicion(void) const
    {
        return *rbegin();
    }
    virtual void Escribe(std::ostream &os) const;
...
//Corresponde a un registro ~M de BC3.
{
    ...
    regBC3_m(const std::string &str);
    virtual StrTok &decod_bc3(StrTok &strtk);
    virtual void Escribe(std::ostream &os) const;
};

//! @brief Corresponde a un registro ~C de BC3.
struct regBC3_c: public regBC3
{
    ...
    regBC3_c(const std::string &str);
    virtual StrTok &decod_bc3(StrTok &strtk);
    virtual void Escribe(std::ostream &os) const;
};

//! @brief Corresponde a un registro ~T de BC3.
struct regBC3_t: public regBC3
{
    std::string texto;

    regBC3_t(void): texto("") {}
    regBC3_t(const std::string &str);
    virtual StrTok &decod_bc3(StrTok &strtk);
    virtual void Escribe(std::ostream &os) const;
};
...
struct regBC3_elemento
{
    ...
    regBC3_elemento(const regBC3_c &c,const regBC3_t &t)
        : ccpto(c),txt(t) {}
    ...
    const long double &Precio(void) const
    {
        return ccpto.precio;
    }
    short int Tipo(void) const
    {
        return ccpto.tipo;
    }
    const std::string &Texto(void) const
    {
        return txt.texto;
    }
    virtual void Escribe(std::ostream &os) const
...
struct regBC3_udobra : public regBC3_elemento
{
    ...
    regBC3_udobra(const regBC3_c &c,const regBC3_t &t,const regBC3_d &d)
...
struct regBC3_medicion : public regBC3_elemento
{
    ...
    regBC3_medicion(const regBC3_c &c,const regBC3_t &t,const regBC3_m &m)
        : regBC3_elemento(c,t),med(m) {}
    regBC3_ruta Ruta(void) const
    {
        return med.ruta;
    }
    virtual void Escribe(std::ostream &os) const
...
std::ostream &operator<<(std::ostream &,const regBC3_medicion &);

struct regBC3_capitulo: public regBC3_udobra
{
    regBC3_capitulo(const regBC3_c &c,const regBC3_t &t,const regBC3_d &d);
    regBC3_d FiltraCapitulos(const std::set<std::string> &nombres_capitulo) const;
};
