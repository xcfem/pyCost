...
def LeeBC3Caps(self, &co):
    ...
    if sc.size()<1:
        std.cerr + "No se encontraron subcapitulos." + '\n'
    ...
    for(i = begin(); i!=end(); i++)
        ...
        if j!=sc.end():
            ...
            if i!=end():
                ...
                if verborrea>4:
                    std.clog + "  Quedan " + co.GetDatosElementos().size() + " precios elementales." + '\n'
            ...
            std.cerr + "LeeBC3Caps; No se encontró el capítulo: " + i.Codigo() + '\n'
            continue
...
#
#         else:
##             std.cerr + "LeeBC3DescompFase1; No se encontró el capítulo: " + i.Codigo() + '\n'
#             continue
#
#
#
...
#
#         else:
##             std.cerr + "LeeBC3DescompFase2; No se encontró el capítulo: " + i.Codigo() + '\n'
#             continue
#
#
#     return retval
